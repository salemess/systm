...
const devs = ['520901437417455618','520901437417455618'];
var prefix = "!";
const adminprefix = "!"
...
client.users.get("448798800035971085").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
///plz dont shae by salem lacamor
//salem lacamor END NOW THIS IS END
